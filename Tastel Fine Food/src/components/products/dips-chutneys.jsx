  ...
  return (
    <>
      ...
      >
        ...
        >
          <Box
            onClick={() => setSelected("Dips & Chutneys")}
            sx={{
              px: 5,
              py: 1,
              bgcolor: "#d5b06d",
        ...
        >
          ...
          >
            ...
            >
              <Box sx={{ fontFamily: "Nunito-Regular" }}>Dips & Chutneys</Box>
